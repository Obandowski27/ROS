...
(cl:defmethod cl:initialize-instance :after ((m <HardwareStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HardwareStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-msg:<HardwareStatus> is deprecated: use messages-msg:HardwareStatus instead.")))
...
(cl:defmethod are_motors_up-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-msg:are_motors_up-val is deprecated.  Use messages-msg:are_motors_up instead.")
  (are_motors_up m))

(cl:ensure-generic-function 'debug_message-val :lambda-list '(m))
(cl:defmethod debug_message-val ((m <HardwareStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-msg:debug_message-val is deprecated.  Use messages-msg:debug_message instead.")
  (debug_message m))
