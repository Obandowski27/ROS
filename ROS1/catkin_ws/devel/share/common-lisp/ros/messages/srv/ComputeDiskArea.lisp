...
(cl:defmethod cl:initialize-instance :after ((m <ComputeDiskArea-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeDiskArea-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<ComputeDiskArea-request> is deprecated: use messages-srv:ComputeDiskArea-request instead.")))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <ComputeDiskArea-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:radius-val is deprecated.  Use messages-srv:radius instead.")
  (radius m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeDiskArea-request>)))
  ...
  "messages/ComputeDiskAreaRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeDiskArea-request)))
  "Returns string type for a service object of type 'ComputeDiskArea-request"
  "messages/ComputeDiskAreaRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ComputeDiskArea-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComputeDiskArea-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<ComputeDiskArea-response> is deprecated: use messages-srv:ComputeDiskArea-response instead.")))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <ComputeDiskArea-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:area-val is deprecated.  Use messages-srv:area instead.")
  (area m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComputeDiskArea-response>)))
  ...
  "messages/ComputeDiskAreaResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComputeDiskArea-response)))
  "Returns string type for a service object of type 'ComputeDiskArea-response"
  "messages/ComputeDiskAreaResponse")
