...
(cl:defmethod cl:initialize-instance :after ((m <SetLed-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLed-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<SetLed-request> is deprecated: use messages-srv:SetLed-request instead.")))

(cl:ensure-generic-function 'led_number-val :lambda-list '(m))
(cl:defmethod led_number-val ((m <SetLed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:led_number-val is deprecated.  Use messages-srv:led_number instead.")
  (led_number m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetLed-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:state-val is deprecated.  Use messages-srv:state instead.")
  (state m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLed-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLed-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages-srv:<SetLed-response> is deprecated: use messages-srv:SetLed-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetLed-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages-srv:success-val is deprecated.  Use messages-srv:success instead.")
  (success m))
